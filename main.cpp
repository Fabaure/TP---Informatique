...
int main() {
    ...
    // Creation d'une Ligne droite animé
    ...
    while (true) {
        //  Lancement des animations des formes crées au début du main
        ...
        // Sortir de la boucle et donc arrêter le programme dès que le bouton ECHAP est presse
        if (waitKey(30) == 27)
            break;
    }
